...
export default function Login({ onAuth }: { onAuth: () => void }) {
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--void)' }}>
      <div className="blueprint" style={{ width: 340, padding: 28, background: 'var(--base)' }}>
        <i className="corner tl" /><i className="corner tr" /><i className="corner bl" /><i className="corner br" />
        <div style={{ display: 'flex', alignItems: 'center', gap: 9, marginBottom: 6 }}>
          <div style={{ width: 24, height: 24, borderRadius: 0, border: '1px solid #5980a666', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--serif)', fontWeight: 600, fontSize: 14, color: '#5980a6' }}>E</div>
          <span style={{ fontFamily: 'var(--serif)', fontWeight: 600, fontSize: 16 }}>elle</span>
          <span style={{ fontFamily: 'var(--mono)', fontSize: 11, color: '#5980a6' }}>workbench</span>
        </div>
        ...
        {reset ? (<>
          ...
          <input value={np1} onChange={e => setNp1(e.target.value)} type="password" placeholder="new password (8+ chars)" autoComplete="new-password"
            style={{ width: '100%', background: 'var(--raised)', border: '0.5px solid var(--b1)', borderRadius: 0, color: 'var(--t1)', padding: '9px 12px', fontSize: 12, fontFamily: 'var(--mono)', outline: 'none', marginBottom: 8 }} />
          <input value={np2} onChange={e => setNp2(e.target.value)} type="password" placeholder="confirm new password" autoComplete="new-password"
            ...
            style={{ width: '100%', background: 'var(--raised)', border: '0.5px solid var(--b1)', borderRadius: 0, color: 'var(--t1)', padding: '9px 12px', fontSize: 12, fontFamily: 'var(--mono)', outline: 'none', marginBottom: 12 }} />
          <button onClick={submitReset} disabled={busy || !np1 || !np2}
            style={{ width: '100%', padding: '9px 0', borderRadius: 0, border: '1px solid #5980a6', background: busy ? '#5980a688' : '#5980a6', color: 'var(--base)', cursor: 'pointer', fontFamily: 'var(--mono)', fontSize: 12, marginBottom: 10 }}>
