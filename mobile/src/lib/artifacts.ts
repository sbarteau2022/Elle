// ============================================================
// artifacts.ts — the grammar of the pictures she makes, for the phone.
//
...
// renderer (mobile/src/lib/md.tsx) turns them into pictures.
//
...
//     Elle/src/lib/artifacts.ts         (the workbench)
//     Elle/mobile/src/lib/artifacts.ts  (this file — the phone; Metro is
//                                        rooted at mobile/, so it cannot
//                                        import the workbench copy)
...
export function artifactUrl(path: string): string { return WORKER_URL + path }
